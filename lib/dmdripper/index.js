...
//JM #C82C23 #F1D1A7 #000000 #F1C251 #B5C0C6 #001689

//TOTAN #EAB540 #C83131 #286395 #000000
...
const LAYOUT = {
  ...
  v4: {
    backgroundColor: 'white',
    colorDmdBackground: 'white',
    colorDmdForeground: POP_EYE_COLORS,
    margin: 64*3,
    dmdFrameWidth: 128,
    dmdFrameHeight: 32,
    dmdFrameMargin: 8*2,
  ...
  v5: {
    ...
    dmdFrameWidth: 128,
    dmdFrameHeight: 32,
    dmdFrameMargin: 8*2, //BUGGY
    dmdFramesHorizontal: 16/1,
...
const canvasWidth = TEMPLATE.margin * 2 + TEMPLATE.dmdFramesHorizontal * dmdFrameWidthMargin;
const canvasHeight = TEMPLATE.margin * 2 + TEMPLATE.dmdFramesVertical * dmdFrameHeightMargin;
...
function extractDmdFramesAndEventuallyQuit(status) {
  ...
  for (var i = 0; i < 16; i++) {
    ...
    if (isNotEmpty && !imageHasBeenAdded) {
      ...
      if (xpos > (canvasWidth - dmdFrameWidthMargin - TEMPLATE.margin)) {
