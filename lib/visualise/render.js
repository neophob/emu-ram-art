...
function render(data, config, renderMetaData) {
  ...
  ctx.fillRect(x, config.imageHeight - config.initialXOffset + config.diagramHeight, diagWidth, config.diagramHeight / 8);
  ctx.fillRect(x, config.initialXOffset, diagWidth, config.diagramHeight / 8);
  ...
  ctx.fillText(
    ...
    config.initialXOffset - config.diagramHeight
  );
/*  ctx.fillText(
