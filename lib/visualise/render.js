...
function render(filteredMemory, config, renderMetaData) {
  ...
  ctx.fillRect(
    textXpos - 5,
    config.imageHeight - config.borderSize - config.fontSize * 2.5,
    config.diagramWidth * config.widthScaleFactor,
    config.diagramHeight
  );
  ...
  ctx.fillText(
    ...
    textXpos,
    config.imageHeight - config.borderSize - config.fontSize * 1.5
  );
